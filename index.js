...
async function main() {
  ...
  window.addEventListener('load', async () => {
    let serviceWorkerRegistration = await navigator.serviceWorker.register('https://mohe2015.github.io/albertforfuture.de/sw.min.js', {scope: 'https://mohe2015.github.io/albertforfuture.de/'})
