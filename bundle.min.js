...
function downloadAllArticles(){if(localStorage.getItem('offline')==='v7'){console.log("articles already downloaded");return;}
setTimeout(function(){window.caches.open('v7').then(function(cache){cache.addAll(["/","/page/2/","/page/3/","/page/4/","/page/5/","/tags/bohemian-browser-ballett/","/categories/","/categories/page/2/","/categories/page/3/","/kohlrabi/","/ecosia/","/categories/empfehlungen/","/tags/greta-thunberg/","/rede-greta-thunberg/","/tags/kosmetik/","/categories/lebensmittelverschwendung/","/tags/meer/","/protokoll/2019-11-19/","/protokoll/2019-10-24/","/categories/mensa-talk/","/mikroplastik-in-kosmetik/","/categories/plastik/","/categories/politik/","/categories/protokoll/","/protokoll/","/protokoll/2019-12-03/","/tags/satire/","/tags/suchmaschine/","/tags/","/tags/page/2/","/plastik-im-meer/","/shell/","/categories/aktuelles/","/datenschutzerklaerung/","/offline/","/impressum/","/infos/",]);}).then(event=>{localStorage.setItem('offline','v7');document.getElementById('toast-offline').classList.remove('d-none');new bootstrap.Toast(document.getElementById('toast-offline'),{delay:5000}).show();document.getElementById('toast-offline').addEventListener('hidden.bs.toast',function(){document.getElementById('toast-offline').remove();})}).catch(error=>{console.log("Fehler beim Offline gehen!",error);});},10000);}
if(false&&'serviceWorker'in navigator){console.log("service worker supported")
