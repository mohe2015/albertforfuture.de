async function install(){let cache=await caches.open('v28')
return await cache.addAll(['/albertforfuture.de/custom.min.css','/albertforfuture.de/logo.min.svg','https://mohe2015.github.io/albertforfuture.de/logo.png','https://mohe2015.github.io/albertforfuture.de/logo_monochrome.png','https://mohe2015.github.io/albertforfuture.de/bundle.js','https://mohe2015.github.io/albertforfuture.de/sw.min.js','/albertforfuture.de/manifest.min.json','https://mohe2015.github.io/albertforfuture.de/offline/'])}
...
await Promise.all(cacheNames.filter(cacheName=>{return cacheName!=='v28'}).map(async cacheName=>{return await caches.delete(cacheName);}))}
...
let cache=await caches.open('v28')
...
const options={body:body.text,icon:'https://mohe2015.github.io/albertforfuture.de/logo.png',badge:'https://mohe2015.github.io/albertforfuture.de/logo_monochrome.png',lang:'de-DE',data:body};event.waitUntil(push(event,options));});